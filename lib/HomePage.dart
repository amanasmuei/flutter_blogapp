        ...
        child: new ListView(
          children: <Widget>[
            ...
            new UserAccountsDrawerHeader(
                accountName: new Text("Code with Mufa"),
                accountEmail: new Text("mufa@gmail.com"),
            ...
            new ListTile(
              ...
              leading: new Icon(Icons.cake, color: Colors.purple,), //leading-icons on the left
            ),
            new ListTile(
            ...
            new ListTile(
              ...
              trailing: new Icon(Icons.close, color: Colors.red,), //trailing - icon on the right
              onTap: () {
